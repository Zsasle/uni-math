\documentclass[a4paper, parskip = true, fleqn]{scrartcl}
...
\begin{exercisebox}[Es seien $a, b \in \mathbb{N}$. Weiter gelte $ b \mid a $. Dann gilt auch $ b \times c \mid a \times c $]
	\begin{proofbox}[Vor.: Es seien $ a, b \in \mathbb{N} $ mit $ b \mid a $]
