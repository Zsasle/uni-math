...
\newcommand{\setnumbersa}[3]{
	\expandafter\xdef\csname#2#3number\endcsname	{\number#1}
}
\newcommand{\setnumbers}[2]{
	...
	\setnumbersa{1}{}{example}
}

\newcommand{\myboxenvironment}[6]{
...
\newcommand{\cachenewenvironmenta}[2]{
...
\newcommand{\cachemyenvironmentb}[6]{
	\expandafter\xdef\csname#1#2number\endcsname{\number1}
	\myboxenvironment{#1}{#2}{#3}{#4}{#5}{#6}
	\cachenewenvironmenta{#1}{#2}
}
\newcommand{\myenvironment}[5]{
	\cachemyenvironmentb{}{#1}{#2}{#3}{#4}{#5}
	\cachemyenvironmentb{sub}{#1}{#2}{#3}{#4}{#5}
}

\myenvironment{problem}		{gadse-light-green}	{gadse-dark-green}	{75}{100}
\myenvironment{exercise}	{gadse-orange}		{gadse-red}		{75}{100}
\myenvironment{example}		{gadse-yellow}		{gadse-orange}		{75}{100}
\myenvironment{definition}	{gadse-pink}		{gadse-pink}		{50}{100}
\myenvironment{theorem}		{gadse-light-green}	{gadse-light-green}	{50}{100}
...
\titleformat{\subsection}{\bfseries}{\thesubsection . }{0pt}{}{\setnumbers{1}{sub}}
