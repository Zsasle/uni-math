...
\section*{Aufgabe 2: Vektorgeometrie}
\begin{enumerate}[label=\alph*)]
	...
	\item $\left| \vec a \times \vec b \right|
		...
		= \sqrt{400+25+24^2} = \sqrt{1001} $, also ist die Fläche des Parallelogramms $\sqrt{1001}$
	\item $ \vec c \cdot \left( \vec a \times \vec b \right) = \vec c \cdot \begin{pmatrix}-20\\5\\24\end{pmatrix} = 9\cdot (-20) + 2\cdot5 + (-7)\cdot24 = -180 + 10 - 168 = -338 $, also ist das Volumen 288\\
		...
		\end{tikzpicture}\\
		An dem Bild erkennt man, dass ${\color{orange!70}\left|\vec a \times \vec b\right|}$ gleich der Grundfläche vom Parallelepipeds ist, da die Richtung von $\vec a \times \vec b$ orthogonal zu der Grundfläche steht, ist die Abbildung von $\vec c$ auf $\vec a \times \vec b $ die Höhe des Parallelepipeds und $ c \cdot \left( \vec a \times \vec b \right) $ ist das Volumen.
\end{enumerate}
