...
hi Normal           ctermfg=2       ctermbg=0       cterm=NONE      guifg=#008000       guibg=#000000   gui=NONE
...
" Syntax Highlighting
"""""""""""""""""""""""
hi Boolean          ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=NONE
hi Character        ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=NONE
hi Comment          ctermfg=11      ctermbg=NONE    cterm=ITALIC    guifg=#FFC511       guibg=NONE      gui=NONE
hi Conditional      ctermfg=5       ctermbg=NONE    cterm=BOLD      guifg=#FF1FCE       guibg=NONE      gui=NONE
hi Constant         ctermfg=13      ctermbg=NONE    cterm=NONE      guifg=#FF1FCE       guibg=NONE      gui=NONE
hi Define           ctermfg=13      ctermbg=NONE    cterm=NONE      guifg=#FF1FCE       guibg=NONE      gui=NONE
hi Error            ctermfg=15      ctermbg=9       cterm=NONE      guifg=#FFFFFF       guibg=#F10000   gui=NONE
hi Float            ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=NONE
hi Function         ctermfg=3       ctermbg=NONE    cterm=BOLD      guifg=#FF8B00       guibg=NONE      gui=NONE
hi Identifier       ctermfg=1       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=italic
hi Keyword          ctermfg=3       ctermbg=NONE    cterm=BOLD      guifg=#FF8B00       guibg=NONE      gui=NONE
hi Label            ctermfg=10      ctermbg=NONE    cterm=NONE      guifg=#66D553       guibg=NONE      gui=NONE
hi Number           ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=NONE
hi Operator         ctermfg=10      ctermbg=NONE    cterm=NONE      guifg=#66D553       guibg=NONE      gui=NONE
...
hi Special          ctermfg=11      ctermbg=NONE    cterm=NONE      guifg=#87D7FF       guibg=NONE      gui=NONE
hi SpecialComment   ctermfg=11      ctermbg=NONE    cterm=UNDERLINE guifg=#FFC511       guibg=NONE      gui=underline
hi SpecialKey       ctermfg=15 	    ctermbg=11      cterm=NONE      guifg=#FFFFFF	guibg=NONE      gui=NONE
hi SpellBad         ctermfg=4       ctermbg=NONE    cterm=ITALIC    guifg=#331EB5       guibg=NONE      gui=undercurl
hi SpellCap         ctermfg=12      ctermbg=NONE    cterm=ITALIC    guifg=#336ED9       guibg=NONE      gui=undercurl
hi SpellRare        ctermfg=14      ctermbg=NONE    cterm=ITAlIC    guifg=#4FA0B7       guibg=NONE      gui=undercurl
hi SpellLocal       ctermfg=6       ctermbg=NONE    cterm=ITALIC    guifg=#331EB5       guibg=NONE      gui=undercurl
hi Statement        ctermfg=5       ctermbg=NONE    cterm=BOLD      guifg=#FF1FCE       guibg=NONE      gui=NONE
hi StorageClass     ctermfg=1       ctermbg=NONE    cterm=BOLD      guifg=#FFAF5F       guibg=NONE      gui=italic
hi String           ctermfg=13      ctermbg=NONE    cterm=NONE      guifg=#FF1FCE       guibg=NONE      gui=NONE
hi Structure        ctermfg=1       ctermbg=NONE    cterm=BOLD      guifg=#FFAF5F       guibg=NONE      gui=NONE
hi Tag              ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=NONE
hi Todo             ctermfg=11      ctermbg=8       cterm=INVERSE   guifg=#5FAFD7       guibg=#1C1C1C   gui=inverse,bold
hi Type             ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#F10000       guibg=NONE      gui=NONE
...
hi pythonConditional    ctermfg=5       ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE " Python
hi pythonDecorator      ctermfg=5       ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE
hi pythonException      ctermfg=5       ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE
hi pythonFunction       ctermfg=3       ctermbg=NONE    cterm=bold      guifg=#5FAFD7       guibg=NONE      gui=NONE
hi pythonInclude        ctermfg=140     ctermbg=NONE    cterm=NONE      guifg=#AF87D7       guibg=NONE      gui=NONE
hi pythonNumber         ctermfg=9       ctermbg=NONE    cterm=NONE      guifg=#D7875F       guibg=NONE      gui=NONE
hi pythonOperator       ctermfg=10      ctermbg=NONE    cterm=bold      guifg=#AF87D7       guibg=NONE      gui=NONE
hi pythonRepeat         ctermfg=3       ctermbg=NONE    cterm=bold      guifg=#AF87D7       guibg=NONE      gui=NONE
hi pythonStatement      ctermfg=5       ctermbg=NONE    cterm=bold      guifg=#AF87D7       guibg=NONE      gui=NONE
